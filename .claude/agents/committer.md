...
### Mandotory
- DO end every commit you author with a `Co-Authored-By:` trailer naming the model that wrote it — see `.claude/skills/core/unity-git.md` for the exact form
- DO NOT put "Generated by Claude" or similar boilerplate in the subject or body — the trailer is the attribution; the body explains what changed and why
