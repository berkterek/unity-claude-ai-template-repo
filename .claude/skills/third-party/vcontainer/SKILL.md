...
> **Project convention:** This file covers general VContainer API. For this project's specific scope hierarchy, `ModuleInstaller` pattern, and DI failure diagnosis, see `.claude/skills/third-party/vcontainer.md`.
