---
name: solid-oop
description: SOLID & OOP kuralları — MonoBehaviour sadece View/Provider olabilir (~100 satır max, business logic yok); SRP tek-cümle testi (AND içermemeli); OCP polymorphism kuralı (if/else chain forbidden); DIP constructor sadece interface alır. Kod yazarken, class tasarlarken veya MonoBehaviour'a logic eklerken kullan.
model-tier: normal
---
