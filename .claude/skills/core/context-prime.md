---
name: context-prime
description: Brief Claude on project context at the start of a session — reads key files and summarizes current state before any work begins
user-invocable: true
model-tier: light
---
...
Use this at the start of a new session to get Claude up to speed quickly.

## Steps

1. Read `.claude/CLAUDE.md` for architecture rules and available commands
2. Read `.claude/rules/architecture.md` for module structure and DI patterns
...
Keep it concise. The goal is to orient Claude, not produce a report for the user.
